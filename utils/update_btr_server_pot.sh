#/bin/bash
### Extract translatable strings of btr_server
### and update the file 'btrserver.pot'.
###
### Run it on a copy of B-Translator Server that is just
### cloned from git, don't run it on an installed
### copy of btr_server, otherwise 'potx-cli.php'
...
### concatenate files 'general.pot' and 'installer.pot' into 'btr_server.pot'
